...
| # | Notebook | Output |
|---|----------|--------|
| 1 | `01_data_ingestion` | Raw MSFT data → Bronze |
| 2 | `02_data_transformation` | Clean data → Silver |
| 3 | `03_feature_engineering` | 69 indicators + labels → Gold |
| 4 | `04_model_training` | XGBoost (51.1% accuracy) |
| 5 | `05_prediction` | Trading signals → Gold |
| 6 | `06_monte_carlo` | Price distributions (1000 simulations) |
| 7 | `07_backtest` | Backtest strategy performance |
